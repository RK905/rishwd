...
/*=============FILTRIP ABSOLUTE FILE PATH ===========*/
define('FILETRIP_ABSOLUTE_PATH', ITECH_FILETRIP_PLUGIN_DIR_PATH . 'filetrip.php');
...
register_activation_hook( FILETRIP_ABSOLUTE_PATH, 'itf_install_filetrip_database' );

//register_activation_hook(  FILETRIP_ABSOLUTE_PATH, array( 'VerifyPIDITF', 'init' ) );
register_activation_hook(  FILETRIP_ABSOLUTE_PATH, 'activate_filetrip_plugin' );

// Register callback that is fired when the plugin is deactivated.
register_deactivation_hook( FILETRIP_ABSOLUTE_PATH, 'filetrip_bkp_deactivate');
