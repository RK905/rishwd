...
class Silphium_Patcher_Client {
	 ...
	 * @var string
	 */
	private static $transient_name     = 'silphium_patches';
	/**
	 * @var string
	 */
	public         $remote_patches_uri = 'https://www.itechflare.com/updates/fixes.txt';
	...
	private function get_cached() {
		...
		if ( $_GET && isset( $_GET['silphium-reset-cached-patches'] ) ) {
			$this->reset_cache();
			return false;
		}
