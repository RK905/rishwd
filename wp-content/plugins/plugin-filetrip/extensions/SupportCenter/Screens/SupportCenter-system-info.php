...
<div id="itf_wp-status-theme-status">
    ...
    <table class="widefat" cellspacing="0">
        ...
        <tr>
            <td><?php _e( 'FileTrip Core Table', 'filetrip-plugin' ); ?></td>
            <td class="help"><?php echo '<a href="#" class="help_tip" data-title="' . esc_attr__( 'FileTrip Core Table', 'filetrip-plugin' ) . '" data-tip="' . esc_attr__( 'This is to check the integrity of the plugin.', 'filetrip-plugin' ) . '">?</a>'; ?></td>
            <td>
                <?php
                    global $wpdb ;
                    ...
                    if($wpdb->get_var("SHOW TABLES LIKE '$table_name'") == $table_name) {
                        echo '<span class="status-ok"><small>'.__('Avaliable', 'filetrip-plugin').'</small></span>';
                    }else{
                        echo '<span class="status-error"><small>'.__('Not Avaliable', 'filetrip-plugin').'</small></span>';
                    }
                ?>
            </td>
        </tr>
        <tr>
            <td><?php _e( 'FileTrip Meta Table', 'filetrip-plugin' ); ?></td>
            <td class="help"><?php echo '<a href="#" class="help_tip" data-title="' . esc_attr__( 'FileTrip Meta Table', 'filetrip-plugin' ) . '" data-tip="' . esc_attr__( 'This is to check the integrity of the plugin.', 'filetrip-plugin' ) . '">?</a>'; ?></td>
            <td>
                <?php
                    global $wpdb ;
