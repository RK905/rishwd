      ...
      <div id="postbox-container-1" class="postbox-container">
        <ul class="arfaly-info-list">
          <li>
            ...
            <span class="icon-star arfaly-total"></span> <?php echo __("Total Statistics Including Deleted", 'filetrip-plugin'); ?><br>
            <span class="icon-star-empty arfaly-ranged-total" ></span> <?php echo __("Actual Statistics <br>Based on selected date range", 'filetrip-plugin'); ?>
          </li>
          <li class="arfaly-total">
            <h3><?php echo __("Total Uploads", 'filetrip-plugin'); ?></h3>
            <span class="icon-help-circled" title="<?php echo __("This figure include all automatically deleted files. Please choose date range and click update to get statistics for the selected time period.", 'filetrip-plugin'); ?>"></span>
          ...
          <li>
            <h3><?php echo __("Total Uploads Avaiable", 'filetrip-plugin'); ?></h3>
            <span class="icon-help-circled" title="<?php echo __("This is the total number of uploads avaliable in your site for the selected period", 'filetrip-plugin'); ?>"></span>
            <span class="icon-upload-cloud"></span>
