    ...
    class Filetrip_Google_Drive_Setting_page
    {
        ...
        function add_setting_fields($fields)
        {
            $channelSettings = array(
				array(
					'name' => Filetrip_Google_Drive::$google_drive_client_id_slug,
				...
				array(
					'name' => Filetrip_Google_Drive::$google_drive_client_secret_slug,
				...
				array(
					'name' => Filetrip_Google_Drive::$google_redirect_url_slug,
        ...
        function print_html_in_page_header()
        {
            ...
            if(isset($drive_setting[Filetrip_Google_Drive::$google_drive_client_id_slug]) && isset($drive_setting[Filetrip_Google_Drive::$google_drive_client_secret_slug]) 
