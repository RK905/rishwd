...
/**
 * FILETRIP_CMB field class
 * @since  1.1.0
 * @method string _id()
 * @method string type()
 */
class FILETRIP_CMB2_Field {
	...
	public function __construct( $args ) {
		 ...
		 * Returning a non 'filetrip_cmb_field_no_override_val' value
		 ...
		 * @param FILETRIP_CMB2_Field object $field_obj   This field object
		 */
		$this->value = apply_filters( 'filetrip_cmb_override_meta_value', 'filetrip_cmb_field_no_override_val', $this->object_id, $this->args(), $this->object_type, $this );

		/**
		 * Filter whether to override getting of meta value.
		 *
		 * The dynamic portion of the hook, $field_id, refers to the current
		 * field id paramater. Returning a non 'filetrip_cmb_field_no_override_val' value
		 * will effectively short-circuit the value retrieval.
		 *
		 * @since 2.0.0
		 *
		 ...
		 * @param FILETRIP_CMB2_Field object $field_obj   This field object
		 */
		$this->value = apply_filters( "filetrip_cmb_override_{$this->id( true )}_meta_value", $this->value, $this->object_id, $this->args(), $this->object_type, $this );

		// If no override, get our meta
		$this->value = 'filetrip_cmb_field_no_override_val' === $this->value
			? $this->get_data()
			: $this->value;
	}
	...
	public function get_data( $field_id = '', $args = array() ) {
		...
		$data = 'options-page' === $a['type']
			? filetrip_cmb_options( $a['id'] )->get( $a['field_id'] )
	...
	public function update_data( $new_value, $single = true ) {
		 ...
		 * @param FILETRIP_CMB2_Field object $field_obj This field object
		 */
		$override = apply_filters( 'filetrip_cmb_override_meta_save', null, $a, $this->args(), $this );
		 ...
		 * @param FILETRIP_CMB2_Field object $field_obj This field object
		 */
		$override = apply_filters( "filetrip_cmb_override_{$a['field_id']}_meta_save", $override, $a, $this->args(), $this );
		...
		if ( 'options-page' === $a['type'] ) {
			return filetrip_cmb_options( $a['id'] )->update( $a['field_id'], $a[ 'value' ], false, $a['single'] );
		}
	...
	public function remove_data( $old = '' ) {
		 ...
		 * @param FILETRIP_CMB2_Field object $field_obj This field object
		 */
		$override = apply_filters( 'filetrip_cmb_override_meta_remove', null, $a, $this->args(), $this );
		 ...
		 * @param FILETRIP_CMB2_Field object $field_obj This field object
		 */
		$override = apply_filters( "filetrip_cmb_override_{$a['field_id']}_meta_remove", $override, $a, $this->args(), $this );
		...
		elseif ( 'options-page' === $a['type'] ) {
			return filetrip_cmb_options( $a['id'] )->remove( $a['field_id'] );
		}
	...
	public function sanitization_cb( $meta_value ) {
		...
		$clean = new FILETRIP_CMB2_Sanitize( $this, $meta_value );
		// Validation via 'FILETRIP_CMB2_Sanitize' (with fallback filter)
	...
	public function escaped_value( $func = 'esc_attr', $meta_value = '' ) {
		...
		$esc = apply_filters( 'filetrip_cmb_types_esc_'. $this->type(), null, $meta_value, $this->args(), $this );
		if ( null !== $esc ) {
			return $esc;
		}
	...
	public function field_timezone_offset() {
		return filetrip_cmb_utils()->timezone_offset( $this->field_timezone() );
	}
	...
	public function get_timestamp_format( $format = 'date_format', $meta_value = 0 ) {
		...
		$meta_value = filetrip_cmb_utils()->make_valid_time_stamp( $meta_value );
	...
	public function render_field() {
		...
		$this_type = new FILETRIP_CMB2_Types( $this );
		$this_type->render();
	...
	/**
	 * Defines the classes for the current FILETRIP_CMB field row
	 *
	 * @since  2.0.0
	...
	public function row_classes() {
		...
		$repeat_table_rows_types = apply_filters( 'filetrip_cmb_repeat_table_row_types', array(
			'text_url', 'text'
		) );
		...
		return apply_filters( 'filetrip_cmb_row_classes', $classes, $this );
	}
	...
	public function _set_field_defaults( $args ) {
		...
		$args['default']    = apply_filters( 'filetrip_cmb_default_filter', $args['default'], $this );
		...
		$option_types = apply_filters( 'filetrip_cmb_all_or_nothing_types', array( 'taxonomy_select', 'taxonomy_radio', 'taxonomy_radio_inline' ), $this );
