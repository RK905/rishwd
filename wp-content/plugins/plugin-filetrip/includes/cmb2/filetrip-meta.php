...
add_filter( 'filetrip_cmb_meta_boxes', 'filetrip_core_metaboxes' );
/**
...
function filetrip_core_metaboxes( array $meta_boxes ) {
    ...
    $link_upload_options = apply_filters('itf/filetrip/channel/cdn_selection', $link_upload_options);
	...
	$meta_boxes['arfaly_cdn_selection'] = array(
		'id'         => 'arfaly_cdn_selection',
		'title'      => __('Generate shared links', 'cmb' ),
		'object_types'      => array( Filetrip_Constants::POST_TYPE ), // Post type
		'context'    => 'normal',
		'priority'   => 'high',
		'show_names' => true,
    ...
    $meta_boxes['new_arfaly_metabox'] = array(
		...
		'fields'     => array(
            ...
            array(
				'name' => __( 'Uploader mode (Disable Multipart)', 'filetrip-plugin' ),
				'desc' => __( 'If you Enable this feature, the uploader will use the native & limited browser uploader. <br/><span style="color:red">Multipart is recommended for uploading larger files (>32MB)</span>', 'filetrip-plugin' ),
