  ...
  */
  function custom_filetrip_bulk_action() {
    ...
    if ( !isset( $_REQUEST['detached'] ) ) {
      ...
      $redirect_args = array(
        'channel' => $action, 
        'source' => Filetrip_Constants::TransferType('media')
        );
  ...
  function distributer_admin_enqueue()
  {
    if(isset($_GET['page']) && $_GET['page'] == 'filetrip_files_distributor')
    {
      ...
      switch($_GET['source']){
        case Filetrip_Constants::TransferType('media'): case Filetrip_Constants::TransferType('forward'):
        ...
        case Filetrip_Constants::TransferType('backup'):
          ...
          $translation_array['source'] = Filetrip_Constants::TransferType('backup');
  ...
  function arfaly_render_files_distributor()
  {
      ...
      <div>
        ...
        <div class="filetrip-distribution-navigation--menu">
          ...
          <?php if($_GET['source']==Filetrip_Constants::TransferType('forward')) { ?>
  ...
  */
  function extract_upload_file_information($att_id, $source)
  {
    ...
    */ 
    ...
    switch($source){
      case Filetrip_Constants::TransferType('media'):
        
        $json_data['source'] = Filetrip_Constants::TransferType('media');
      ...
      case Filetrip_Constants::TransferType('backup'):
        ...
        $json_data['source'] = Filetrip_Constants::TransferType('backup');

        break;

      case Filetrip_Constants::TransferType('forward'):

        $json_data['source'] = Filetrip_Constants::TransferType('forward');
        // Apply filter to retrieve active channels 
